...
LASTKERNEL="/usr/src/kernels/3.10.0-1062.12.1.el7.x86_64"
...
NVINSTALLEDDIR="/usr/src/nvidia-430.50/"
...
#{
#if [ ! -d "$NUKE12DIR" ]; then
#echo "#######  Instalando Nuke 12.0v1  #########" ##### 
#cp -f $SOURCEDIR/Nuke12.0v1-linux-x86-release-64.tgz $INSTALLDIR/Nuke12.0v1-linux-x86-#release-64.tgz
#cd $INSTALLDIR
#tar -xvf $INSTALLDIR/Nuke12.0v1-linux-x86-release-64.tgz
#chmod 777 Nuke-12.0v1-linux-x86-64-installer.run
#cd /usr/local
#$INSTALLDIR/Nuke-12.0v1-linux-x86-64-installer.run
#fi
#}
...
#echo "#######  Instalando Fusion REnder 16  #########" ##### 
...
############### HP RGS receiver ###############
RGSR="/opt/hpremote/rgreceiver/"

if [ ! -d "$RGSR" ]; then
echo "#######  Instalando RGSR #########" ##### 
cp -f $SOURCEDIR/rgreceiver_linux_64-7.6.1.19438-1.el7.x86_64.rpm $INSTALLDIR/rgreceiver_linux_64-7.6.1.19438-1.el7.x86_64.rpm
cd $INSTALLDIR
    rpm -ivh rgreceiver_linux_64-7.6.1.19438-1.el7.x86_64.rpm  --force --replacefiles --nodeps
    cp /opt/hpremote/rgreceiver/rules/rgs-pen-tablet.rules /etc/udev/rules.d/
    echo "export PATH=/opt/hpremote/rgreceiver:$PATH" >> /etc/profile.d/rgsr.sh
fi
