#! /bin/bash
#
# Script Automatizado para Linux CentOS
#
# By Uira Vilanova
...
LASTKERNEL="/usr/src/kernels/3.10.0-1127.13.1.el7.x86_64"
...
echo "192.168.8.81:/mnt/storage/RAW3          /mnt/RAW3               nfs     defaults        0 0" >> /etc/fstab
